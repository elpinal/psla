...
(* OASIS_START *)
(* DO NOT EDIT (digest: 14d4c7f9091b817ba17d99023b30b422) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          bugreports = None;
          synopsis = "This package manages Versions of Python.";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "psla.ml"})
            ];
     ...
     oasis_digest = Some "fR \241\150b\027x=I\247\162\135\242k]";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
